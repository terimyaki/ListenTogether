...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var TabWatcher = (function () {
			function TabWatcher() {
				_classCallCheck(this, TabWatcher);

				this._selector = null;
				this.port = null;
			}

			_createClass(TabWatcher, [{
				key: 'haveMediaPlayer',

				//checks to see if there is media player on the page
				value: function haveMediaPlayer() {
					return this.selector.length;
				}
			}, {
				key: 'mediaIsPlaying',
				value: function mediaIsPlaying() {
				...
				key: 'observeMediaPlayer',
				value: function observeMediaPlayer() {
				...
				key: 'selector',
				get: function get() {
					return (0, _jquery2['default'])(this._selector).find('video');
				},
